                ...
                <div class="row">
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li  role="presentation" class="active"><a style="color: #2c944a" href="#login" aria-controls="home" role="tab" data-toggle="tab" id="tab_login"> <span class="glyphicon glyphicon-log-in" aria-hidden="true"> </span> &nbsp; Đăng nhập</a></li>
                            <li role="presentation"><a  style="color: blue" href="#register" aria-controls="profile" role="tab" data-toggle="tab" id="tab_register"><i class="fa fa-user" aria-hidden="true">+</i> Đăng ký</a></li>
                            <li role="presentation"><a style="color: red" href="#forgetPassword" aria-controls="messages" role="tab" data-toggle="tab" id="tab_forgetpassword"> <i class="fa fa-key" aria-hidden="true"></i> Quên mật khẩu</a></li>
                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12">
                                            <div class="my-form-group-1 marginbottom15">
                                                <div class="my-form-control-1 hidden-xs">Email*</div>
                                            ...
                                            <div class="my-form-group-1 marginbottom15">
                                                <div class="my-form-control-1 hidden-xs">Mật khẩu*</div>
                                                <div class="my-form-control-1 border">
                                            ...
                                            <div class="my-form-group-1 marginbottom0">
                                                <div class="my-form-control-1 remember"> </div>
                                                <div class="my-form-control-1 paddingleft0 hidden-xs">
                                        ...
                                        <div class="col-md-5 col-sm-12 col-xs-12 social-login">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="register">
                                <div class="my-container-1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12">
                                            <div class="my-form-group-1 marginbottom15">
                                                <div class="my-form-control-1 hidden-xs">Họ và tên*</div>
                                                <div class="my-form-control-1 border">
                                            ...
                                            <div class="my-form-group-1 marginbottom15">
                                                <div class="my-form-control-1 hidden-xs">Điện thoại*</div>
                                                <div class="my-form-control-1 border">
                                            ...
                                            <div class="my-form-group-1 marginbottom15">
                                                <div class="my-form-control-1 hidden-xs">Nhập lại*</div>
                                                <div class="my-form-control-1 border">
                                                    <i class="fa fa-key fa-fw" aria-hidden="true"></i>
                                                    <span class="vr"></span>
                                            ...
                                            <div class="my-form-group-1 marginbottom0">
                                                ...
                                                <div class="my-form-control-1 paddingleft0">
                                                    ...
                                                    <?php $this->load->view('common/navbar/terms'); ?>
                                                </div>
                                                <div class="clr"></div>
                                            </div>
                                            <div class="my-form-group-1 marginbottom10 margintop10">
                                ...
                                <div class="my-container-1 textaligncenter" id="forgetPasswordHTML1">
                                    ...
                                    <div class="my-form-group-1 marginbottom10 margintop10">
                                        <div class="my-form-control-1 return">
                                            <button class="my-btn" id="back_to_login"> <i class="fa fa-arrow-left" aria-hidden="true"></i> QUAY LẠI</button>
                                        </div>
                                        <div class="my-form-control-1 confirm">
                                            <button class="my-btn" id="forgetPassBtn"> XÁC NHẬN <i class="fa fa-arrow-right" aria-hidden="true"> </i></button>
                                        </div>
                                        <div class="clr"></div>
                                    </div>
                                </div>
